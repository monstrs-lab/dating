...
export interface ActivateQuestionaireProps {
  onConfirm: () => void
  onCancel: () => void
}

export const ActivateQuestionaire = ({
  onConfirm,
  onCancel,
}: ActivateQuestionaireProps): ReactElement => (
  <Column minHeight='100%' p='2x' overflow='auto'>
    <Row alignItems='center' justifyContent='center'>
      ...
      <Layout>
        <Text fontSize='regular'>Активация анкеты</Text>
      </Layout>
      <Layout flexBasis='5x' flexGrow={1} display={{ mobile: 'flex', desktop: 'none' }} />
    </Row>
